...
urlpatterns = [
    ...
    path('girls-hostels/<int:pk>/', views.GirlsHostelListAPIView.as_view(), name='girls-hostel-detail'),

    path('boys-hostels/', views.BoysHostelListAPIView.as_view(), name='boys-hostels-list'),
    path('boys-hostels/<int:pk>/', views.BoysHostelListAPIView.as_view(), name='boys-hostel-detail'),

    path('girls-pgs/', views.GirlsPgListAPIView.as_view(), name='girls-pgs-list'),
    path('girls-pgs/<int:pk>/', views.GirlsPgListAPIView.as_view(), name='girls-pg-detail'),

    path('boys-pgs/', views.BoysPgListAPIView.as_view(), name='boys-pgs-list'),
    path('boys-pgs/<int:pk>/', views.BoysPgListAPIView.as_view(), name='boys-pg-detail'),

    path('tiffins/', views.TiffinListAPIView.as_view(), name='tiffins-list'),
    path('tiffins/<int:pk>/', views.TiffinListAPIView.as_view(), name='tiffin-detail'),
]
